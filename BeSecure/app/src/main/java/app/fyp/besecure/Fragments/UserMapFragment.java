...
public class UserMapFragment extends Fragment implements OnMapReadyCallback,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mMapView.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap mMap) {
                ...
                googleMap.addMarker(new MarkerOptions().position(Sargodha).title("Bus Position").snippet("Route No. 11"));
    ...
    public void onLocationChanged(Location location) {
        ...
        googleMap.addMarker(new MarkerOptions().position(currentLocation).title("Driver position"));
